...
- uwp
- hackathon
meta_description: 'This code was used in a presentation I gave on Artificial Intelligence and Azure Cognitive Services.  I demonstrate how using a combination of cognitive services such as Speech to Text, Text to Speech, QnAMaker and Image recognition you can make a fairly intelligent chatbot that can interact with you in interesting ways.'
